...
// WiFi
constexpr const char* WIFI_SSID = "OnePlus Ace 2 Pro";
constexpr const char* WIFI_PASSWORD = "123456711";

// Backend
constexpr const char* URL_SERVER_ALLOCATE = "http://192.168.1.100:3000/api/bin/allocate";
// TODO!
